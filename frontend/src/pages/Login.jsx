...
export default function Login() {
  ...
  async function handleLogin(e) {
    ...
    try {
      ...
      setSubmitError(getErrorMessage(err, "Incorrect email or password. Please try again."));
    } finally {
    ...
    <div className="relative min-h-screen flex justify-center items-center overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-indigo-100 dark:from-gray-950 dark:via-gray-950 dark:to-gray-900 px-4 transition-colors duration-200">
      ...
      >
        ...
        <div className="mb-6 flex justify-center">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-700 dark:from-indigo-600 dark:to-indigo-800 shadow-lg shadow-indigo-300/50 dark:shadow-none">
            <svg className="h-7 w-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 11c1.657 0 3-1.79 3-4S13.657 3 12 3s-3 1.79-3 4 1.343 4 3 4z" />
              <path strokeLinecap="round" strokeLinejoin="round" d="M5.121 20a7 7 0 1113.758 0H5.121z" />
            </svg>
          </div>
        </div>
        ...
        <div className="mb-6 mt-2 flex justify-end">
          <Link to="/forgot-password" className="text-xs font-medium text-indigo-600 dark:text-indigo-400 transition-colors hover:text-indigo-800 dark:hover:text-indigo-300">
            Forgot password?
          </Link>
        </div>
